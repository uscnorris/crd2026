...
function saveIdentity() {
  ...
  if (!name || !role) { alert('Please enter your name and select your role.'); return; }
  user = { name, role };
  saveState();
  showPostIdentity();
}
...
function showPostIdentity() {
  ...
  if (CONFIG.coffee_consult_roles.includes(user.role)) {
    document.getElementById('mylist-header-btn').style.display = 'flex';
  }
