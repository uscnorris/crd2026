...
const CONFIG = {
  ...
  agenda: [
    ...
    { time: "9:15–9:45 AM", loc: "Mayer Auditorium", title: "Machine learning for cancer discovery", desc: "Ruishan Liu, PhD.", tag: "Tentative", tbd: true },
    { time: "9:45–10:15 AM", loc: "Mayer Auditorium", title: "AI in the surgical suite", desc: "Giovanni Cacciamani, MD." },
    { time: "10:15–10:45 AM", loc: "Mayer Auditorium", title: "Computational & data-driven oncology", desc: "Sheng Li, PhD." },
    { time: "10:45–11:00 AM", loc: "Mayer Auditorium", title: "Break", desc: "" },
    { time: "11:00–11:30 AM", loc: "Mayer Auditorium", title: "AI-powered medical imaging", desc: "Vinay Duddalwar, MD.", tag: "Tentative", tbd: true },
    { time: "11:30 AM–12:00 PM", loc: "Mayer Auditorium", title: "Genetics, risk & precision counseling", desc: "Charité Ricker, MS, CGC.", tag: "Tentative", tbd: true },
    { time: "12:00–12:30 PM", loc: "Mayer Auditorium", title: "Community outreach & the reach of research", desc: "Lourdes Baezconde-Garbanati, PhD, and Bianca Rosales — Community Outreach & Engagement (COE)." },
    { time: "12:30 PM", loc: "Pappas Quad",      title: "Lunch & networking", desc: "Connect across the Cancer Center in person. Browse the directory to see who will be at the poster session." },
